...
\begin{proof}
	\begin{enumerate}
		\item $\vec{E} = - \nabla V = -80 \hat{\varphi} \, \dfrac{C}{m}$.\\
		$\mathrm{u} = \dfrac{\varepsilon_0}{2}E^2 
		= \dfrac{\varepsilon_0}{2}(-80)^2 = 320 \varepsilon_0 \, \dfrac{J}{m^3}$.\\
		$W = \mathrm{u}\tau 
		= 320\varepsilon_0 \cdot 2 \times 10^{-1} \pi \cdot 
		(4-2) \times 10^{-2} \cdot 1 \, \mathrm{J}
		= 320\varepsilon_04\pi \times 10^{-3} \, \mathrm{J}
		= \boxed{\dfrac{320}{k_e} \, \mathrm{J}}$.
		\item Poiché $\mathrm{u}$ è costante, il suo massimo nella regione considerata
		coincide con il valore calcolato precedentemente.
